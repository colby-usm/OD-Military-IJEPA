'''
Script used to process the image data from the KIIT military asset data set

This is used before data labeling
'''
import os
import random
...
def load_data(directory):
    '''
    this function shuffles the data and enumerates the data 1 through n
    '''
